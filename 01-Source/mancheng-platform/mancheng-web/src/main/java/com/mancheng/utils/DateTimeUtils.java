...
public class DateTimeUtils implements Serializable {
   ...
   * 取当天23点59分59秒  Date
   */
  public static Date getTodayEndForDate() {
    Calendar calendar = Calendar.getInstance();
    // 如果没有这种设定的话回去系统的当期的时间
   ...
   * 获取输入日期前或后N个小时
   */
  public static Date getHourTime(Date date,Integer hour){
    Calendar calendar = Calendar.getInstance();
    calendar.setTime(date);
    calendar.add(Calendar.HOUR_OF_DAY, hour);
    return calendar.getTime();
   ...
   * 获取输入日期前或后N天
   */
  public static Date getDayTime(Date date,Integer day){
    Calendar calendar = Calendar.getInstance();
    calendar.setTime(date);
    calendar.add(Calendar.DAY_OF_MONTH, day);
    return calendar.getTime();
  ...
  public static Date getStartOfYear(String year){
    String startOfYear = year + "-01-01 00:00:00";
    try {
      return convertStringToDate(startOfYear, null);
    } catch (ParseException e) {
  ...
  public static Date getEndOfYear(String year){
    String endOfYear = year + "-12-31 23:59:59";
    try {
      return convertStringToDate(endOfYear, null);
    } catch (ParseException e) {
      // TODO Auto-generated catch block
      e.printStackTrace();
      return null;
  ...
  public static String getNextYear(){
	  ...
	  int nextYear = year + 1;
	  return new Integer(nextYear).toString();
  }
  
  public static Date getStartOfOneDay(String day){
	    String startOfday = day + " 00:00:00";
	    try {
	      return convertStringToDate(startOfday, null);
	    } catch (ParseException e) {
	      // TODO Auto-generated catch block
	      e.printStackTrace();
	      return null;
  ...
  public static Date getEndOfOneDay(String day){
	    String endOfDay = day + " 23:59:59";
	    try {
	      return convertStringToDate(endOfDay, null);
	    } catch (ParseException e) {
	      // TODO Auto-generated catch block
	      e.printStackTrace();
	      return null;
