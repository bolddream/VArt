package com.mancheng.controller.base;
...
import com.mancheng.beans.DateEditor;
...
public class BaseController{
	...
	/** 错误消息 */
	protected static final Message ERROR_MESSAGE = Message.error("jlr.message.error");

	/** 成功消息 */
	protected static final Message SUCCESS_MESSAGE = Message.success("jlr.message.success");
